...
func TestMirror(t *testing.T) {
	...
	t.Run("Testing Worker : should pass", func(t *testing.T) {
		err := m.Run("docker://localhost.localdomain:5000/test", "oci:test", "copy", &opts, *writer)
		if err != nil {
			t.Fatal("should pass")
		}
	})
...
func (o *mockMirrorCopy) CopyImage(pc *signature.PolicyContext, destRef, srcRef types.ImageReference, opts *copy.Options) ([]byte, error) {
	return []byte("test"), nil
}

func (o *mockMirrorDelete) DeleteImage(dest string, opts *CopyOptions) error {
	return nil
}
