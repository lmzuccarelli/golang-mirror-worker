...
func TestWorker(t *testing.T) {
	...
	global := &mirror.GlobalOptions{TlsVerify: false, InsecurePolicy: true, LogDir: "../../logs"}
...
func (o *Mirror) Run(src, dest, mode string, opts *mirror.CopyOptions, out bufio.Writer) (retErr error) {
	return nil
}
